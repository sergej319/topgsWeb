...
if (isset($_POST['submit'])) {
    ...
    if ($_POST['confirm_password'] == $_POST['password']) {
        ...
        if(!empty($row)){
            ...
            $sql1 = "INSERT INTO users(fname, lname, username, email, password, code)
            VALUES ('$fname','$lname','$username','$email','$password', '$code')";
            ...
            if ($res1 == TRUE) {
                ...
                //Redirect stranica
                header("location:/topgs/verify_email.php?code=$code");
            } else {
